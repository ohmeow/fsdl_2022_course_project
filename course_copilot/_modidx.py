  ...
  'syms': { 'course_copilot.preprocessing': { 'course_copilot.preprocessing.build_segmentation_train_df': ( 'preprocessing.html#build_segmentation_train_df',
            ...
            'course_copilot.topic_segmentation': { 'course_copilot.topic_segmentation.MarginRankingLoss': ( 'topic_segmentation.html#marginrankingloss',
                                                   ...
                                                   'course_copilot.topic_segmentation.TopicSegmentationModelTrainer.get_training_data': ( 'topic_segmentation.html#topicsegmentationmodeltrainer.get_training_data',
                                                                                                                                          'course_copilot/topic_segmentation.py'),
                                                   'course_copilot.topic_segmentation.TopicSegmentationModelTrainer.predict': ( 'topic_segmentation.html#topicsegmentationmodeltrainer.predict',
                                                                                                                                'course_copilot/topic_segmentation.py'),
                                                   ...
                                                   'course_copilot.topic_segmentation.blurr_splitter_with_head': ( 'topic_segmentation.html#blurr_splitter_with_head',
                                                                                                                   'course_copilot/topic_segmentation.py'),
                                                   'course_copilot.topic_segmentation.build_neg_inputs': ( 'topic_segmentation.html#build_neg_inputs',
                                                                                                           'course_copilot/topic_segmentation.py'),
                                                   'course_copilot.topic_segmentation.build_pos_inputs': ( 'topic_segmentation.html#build_pos_inputs',
                                                                                                           'course_copilot/topic_segmentation.py'),
                                                   'course_copilot.topic_segmentation.build_targets': ( 'topic_segmentation.html#build_targets',
                                                                                                        'course_copilot/topic_segmentation.py'),
                                                   'course_copilot.topic_segmentation.depth_score_cal': ( 'topic_segmentation.html#depth_score_cal',
                                                                                                          'course_copilot/topic_segmentation.py'),
                                                   'course_copilot.topic_segmentation.get_dls': ( 'topic_segmentation.html#get_dls',
                                                                                                  'course_copilot/topic_segmentation.py'),
                                                   'course_copilot.topic_segmentation.get_learner': ( 'topic_segmentation.html#get_learner',
                                                                                                      'course_copilot/topic_segmentation.py'),
                                                   'course_copilot.topic_segmentation.get_preds': ( 'topic_segmentation.html#get_preds',
                                                                                                    'course_copilot/topic_segmentation.py'),
                                                   'course_copilot.topic_segmentation.get_task_hf_objects': ( 'topic_segmentation.html#get_task_hf_objects',
                                                                                                              'course_copilot/topic_segmentation.py'),
                                                   'course_copilot.topic_segmentation.get_training_data': ( 'topic_segmentation.html#get_training_data',
                                                                                                            'course_copilot/topic_segmentation.py'),
                                                   'course_copilot.topic_segmentation.get_validation_preds': ( 'topic_segmentation.html#get_validation_preds',
                                                                                                               'course_copilot/topic_segmentation.py'),
            ...
            'course_copilot.training': { 'course_copilot.training.ModelTrainer': ( 'training.html#modeltrainer',
                                         ...
                                         'course_copilot.training.ModelTrainer.get_training_data': ( 'training.html#modeltrainer.get_training_data',
                                                                                                     'course_copilot/training.py'),
                                         'course_copilot.training.ModelTrainer.predict': ( 'training.html#modeltrainer.predict',
                                                                                           'course_copilot/training.py'),
